...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("123", "1", True), # Негативный тест: проверка ввода цифр
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("123", "2", "13"), # Негативный тест: проверка ввода цифр
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("123", "3", True), # Негативный тест: проверка ввода цифр
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("123", False), # Негативный тест: проверка ввода цифр
